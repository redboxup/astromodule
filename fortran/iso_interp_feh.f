...
!                                                                        !
!     To compile:      gfortran -o iso_interp_feh iso_interp_feh.f       !
!                                                                        !
...
!------------------------------------------------------------------------!
      ...
      integer, parameter :: isonum=1, nafe=6, ncol=16, maxcol=77
...
! obtain user input:
      ...
      write(*,*) '    [16] Gaia DR2 Revised  : Synthetic (Vega)    '
